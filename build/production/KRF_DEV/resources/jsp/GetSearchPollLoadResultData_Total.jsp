...
sql += "       FROM (                                                                                                                                                                   ";
sql += "             SELECT '1' AS NO, '소계' AS GUBUN, WS_NM, WS_CD, AM_NM, AM_CD, SW_NAME, SW_CODE, DO_NM, CTY_NM, DONG_NM, RI_NM, ADM_CD, CAT_DID, '' AS PERCENTAGE -- 면적율        ";
sql += "                  , GNR_BOD_SUM, GNR_TN_SUM, GNR_TP_SUM, OUT_BOD_SUM, OUT_TN_SUM, OUT_TP_SUM                                                                                    ";
sql += "               FROM POLLULANT_LOAD_FOR_CAT                                                                                                                                      ";
sql += "             UNION                                                                                                                                                              ";
sql += "             SELECT '2' AS NO, '생활계' AS GUBUN, WS_NM, WS_CD, AM_NM, AM_CD, SW_NAME, SW_CODE, DO_NM, CTY_NM, DONG_NM, RI_NM, ADM_CD, CAT_DID, '' AS PERCENTAGE -- 면적율      ";
sql += "                  , GNR_BOD_POP, GNR_TN_POP, GNR_TP_POP, OUT_BOD_POP, OUT_TN_POP, OUT_TP_POP                                                                                    ";
sql += "               FROM POLLULANT_LOAD_FOR_CAT                                                                                                                                      ";
sql += "             UNION                                                                                                                                                              ";
sql += "             SELECT '3' AS NO, '축산계' AS GUBUN, WS_NM, WS_CD, AM_NM, AM_CD, SW_NAME, SW_CODE, DO_NM, CTY_NM, DONG_NM, RI_NM, ADM_CD, CAT_DID, '' AS PERCENTAGE -- 면적율      ";
sql += "                  , GNR_BOD_ANI, GNR_TN_ANI, GNR_TP_ANI, OUT_BOD_ANI, OUT_TN_ANI, OUT_TP_ANI                                                                                    ";
sql += "               FROM POLLULANT_LOAD_FOR_CAT                                                                                                                                      ";
sql += "             UNION                                                                                                                                                              ";
sql += "             SELECT '4' AS NO, '산업계' AS GUBUN, WS_NM, WS_CD, AM_NM, AM_CD, SW_NAME, SW_CODE, DO_NM, CTY_NM, DONG_NM, RI_NM, ADM_CD, CAT_DID, '' AS PERCENTAGE -- 면적율      ";
sql += "                  , GNR_BOD_IND, GNR_TN_IND, GNR_TP_IND, OUT_BOD_IND, OUT_TN_IND, OUT_TP_IND                                                                                    ";
sql += "               FROM POLLULANT_LOAD_FOR_CAT                                                                                                                                      ";
sql += "             UNION                                                                                                                                                              ";
sql += "             SELECT '5' AS NO, '토지계' AS GUBUN, WS_NM, WS_CD, AM_NM, AM_CD, SW_NAME, SW_CODE, DO_NM, CTY_NM, DONG_NM, RI_NM, ADM_CD, CAT_DID, '' AS PERCENTAGE -- 면적율      ";
sql += "                  , GNR_BOD_LAND, GNR_TN_LAND, GNR_TP_LAND, OUT_BOD_LAND, OUT_TN_LAND, OUT_TP_LAND                                                                              ";
sql += "               FROM POLLULANT_LOAD_FOR_CAT                                                                                                                                      ";
sql += "             UNION                                                                                                                                                              ";
sql += "             SELECT '6' AS NO, '양식계' AS GUBUN, WS_NM, WS_CD, AM_NM, AM_CD, SW_NAME, SW_CODE, DO_NM, CTY_NM, DONG_NM, RI_NM, ADM_CD, CAT_DID, '' AS PERCENTAGE -- 면적율      ";
sql += "                  , GNR_BOD_FISH, GNR_TN_FISH, GNR_TP_FISH, OUT_BOD_FISH, OUT_TN_FISH, OUT_TP_FISH                                                                              ";
sql += "               FROM POLLULANT_LOAD_FOR_CAT                                                                                                                                      ";
sql += "             UNION                                                                                                                                                              ";
sql += "             SELECT '7' AS NO, '매립계' AS GUBUN, WS_NM, WS_CD, AM_NM, AM_CD, SW_NAME, SW_CODE, DO_NM, CTY_NM, DONG_NM, RI_NM, ADM_CD, CAT_DID, '' AS PERCENTAGE -- 면적율      ";
...
sql += "              , '' AS SW_CODE                                                                                                                                                   ";
sql += "              , '' AS ADM_CD                                                                                                                                                    ";
sql += "              , '' AS WS_NM, '' AS AM_NM, '' AS SW_NAME, '' AS CAT_DID, '총계' AS ADDR, '' AS PERCENTAGE, GUBUN                                                                 ";
...
sql += "         UNION                                                                                                                                                                  ";
sql += "         SELECT '2', A.NO, WS_CD, SW_CODE, ADM_CD, WS_NM, AM_NM, SW_NAME, CAT_DID, ADDR, PERCENTAGE, GUBUN, 		                                                	";
sql += "                 GNR_BOD_SUM, GNR_TN_SUM, GNR_TP_SUM, OUT_BOD_SUM, OUT_TN_SUM, OUT_TP_SUM                                                                                      ";
