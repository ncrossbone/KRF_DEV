...
if(firstSearch.equals("date")){	
	...
	sql = "  SELECT '9999' AS NO , MAX (WMYR||'.'||WMOM||'.'||WMOD) AS WMYR  FROM SDM_RWMDTI WHERE PT_NO IN ("+siteIds+")  		";
}

//select  '9999' as   RN , max(updt) AS RWM from SDM_RWMPT where pt_no in ('2018R55')
//}else{
