		...
		load: function(store) {
			...
			queryTask.execute(query, function(result){
				...
				$.each(arrGroupCodes, function(cnt, groupCode){
					...
					jsonStr += "		\"cls\": \"khLee-x-tree-node-text-bold\",\n";
					if(groupFeature[0].attributes.GROUP_CODE == "G" || groupFeature[0].attributes.GROUP_CODE == "E" || groupFeature[0].attributes.GROUP_CODE == "C" || groupFeature[0].attributes.GROUP_CODE == "I"){
					...
					$.each(arrLayerCodes, function(cnt, layerCode){
						...
						if(layerFeatures[0].attributes.GROUP_CODE == "G" || layerFeatures[0].attributes.GROUP_CODE == "E" || layerFeatures[0].attributes.EQ_EVENT_YN == "Y" || layerFeatures[0].attributes.GROUP_CODE == "C" || layerFeatures[0].attributes.GROUP_CODE == "I"){
							jsonStr += "				\"srchBtnDisabled\": true,\n";
						}
						...
						$.each(layerFeatures, function(cnt, layerFeature){
							...
							if(layerFeature.attributes.EXT_DATA_ID == undefined || layerFeature.attributes.EXT_DATA_ID == null){
								...
								jsonStr += "				\"leaf\": true,\n";
								jsonStr += "				\"checked\": null\n";
								if(layerFeature.attributes.GROUP_CODE == "G" || layerFeature.attributes.GROUP_CODE == "E" || layerFeature.attributes.GROUP_CODE == "C" || layerFeature.attributes.GROUP_CODE == "I"){
