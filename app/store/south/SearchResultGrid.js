Ext.define('KRF_DEV.store.south.SearchResultGrid', {
    ...
    fields: [
        ...
        'CURR_HCHO',
        'CURR_HCB',
        {name:'CHART_AMNT',type:'number'},
        {name:'CHART_DTN',type:'number'},
        {name:'CHART_NO3N',type:'number'},
        {name:'CHART_NH3N',type:'number'},
        {name:'CHART_DTP',type:'number'},
        {name:'CHART_POP',type:'number'},
        {name:'CHART_TRANS',type:'number'},
        {name:'CHART_ALGOL',type:'number'},
        {name:'CHART_TCOLI',type:'number'},
        {name:'CHART_ECOLI',type:'number'},
        {name:'CHART_ANTIMON',type:'number'},
        {name:'CHART_PHENOL',type:'number'},
        {name:'CHART_COL',type:'number'},
        {name:'CHART_NHEX',type:'number'},
        {name:'CHART_MN',type:'number'},
        {name:'CHART_FE',type:'number'},
        {name:'CHART_CD',type:'number'},
        {name:'CHART_CN',type:'number'},
        {name:'CHART_PB',type:'number'},
        {name:'CHART_CR6',type:'number'},
        {name:'CHART_CR',type:'number'},
        {name:'CHART_AS',type:'number'},
        {name:'CHART_HG',type:'number'},
        {name:'CHART_CU',type:'number'},
        {name:'CHART_ZN',type:'number'},
        {name:'CHART_FL',type:'number'},
        {name:'CHART_ABS',type:'number'},
        {name:'CHART_CL',type:'number'},
        {name:'CHART_TCE',type:'number'},
        {name:'CHART_PCE',type:'number'},
        {name:'CHART_CCL4',type:'number'},
        {name:'CHART_DCETH',type:'number'},
        {name:'CHART_DCM',type:'number'},
        {name:'CHART_BENZENE',type:'number'},
        {name:'CHART_CHCL3',type:'number'},
        {name:'CHART_OP',type:'number'},
        {name:'CHART_PCB',type:'number'},
        {name:'CHART_DEHP',type:'number'},
        {name:'CHART_HCHO',type:'number'},
        {name:'CHART_HCB',type:'number'}
    ],
