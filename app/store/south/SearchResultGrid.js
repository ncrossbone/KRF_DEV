        			...
        			if(jsonData.data.length > 0){
	        			...
	        			if(jsonData.data[0].msg == undefined || jsonData.data[0].msg == ""){
	        				...
	        				for(var cnt = 0 ; cnt<a.length ; cnt++){
	        					a[cnt].CHART_ABS.splice(0, a[cnt].CHART_ABS.length - 5);
	        					a[cnt].CHART_ALGOL.splice(0, a[cnt].CHART_ALGOL.length - 5);
	        					a[cnt].CHART_AMNT.splice(0, a[cnt].CHART_AMNT.length - 5);
	        					a[cnt].CHART_ANTIMON.splice(0, a[cnt].CHART_ANTIMON.length - 5);
	        					a[cnt].CHART_AS.splice(0, a[cnt].CHART_AS.length - 5);
	        					a[cnt].CHART_BENZENE.splice(0, a[cnt].CHART_BENZENE.length - 5);
	        					a[cnt].CHART_BOD.splice(0, a[cnt].CHART_BOD.length - 5);
	        					a[cnt].CHART_CCL4.splice(0, a[cnt].CHART_CCL4.length - 5);
	        					a[cnt].CHART_CD.splice(0, a[cnt].CHART_CD.length - 5);
	        					a[cnt].CHART_CHCL3.splice(0, a[cnt].CHART_CHCL3.length - 5);
	        					a[cnt].CHART_CL.splice(0, a[cnt].CHART_CL.length - 5);
	        					a[cnt].CHART_CLOA.splice(0, a[cnt].CHART_CLOA.length - 5);
	        					a[cnt].CHART_CN.splice(0, a[cnt].CHART_CN.length - 5);
	        					a[cnt].CHART_COD.splice(0, a[cnt].CHART_COD.length - 5);
	        					a[cnt].CHART_COL.splice(0, a[cnt].CHART_COL.length - 5);
	        					a[cnt].CHART_CR.splice(0, a[cnt].CHART_CR.length - 5);
	        					a[cnt].CHART_CR6.splice(0, a[cnt].CHART_CR6.length - 5);
	        					a[cnt].CHART_CU.splice(0, a[cnt].CHART_CU.length - 5);
	        					a[cnt].CHART_DCETH.splice(0, a[cnt].CHART_DCETH.length - 5);
	        					a[cnt].CHART_DCM.splice(0, a[cnt].CHART_DCM.length - 5);
	        					a[cnt].CHART_DEHP.splice(0, a[cnt].CHART_DEHP.length - 5);
	        					a[cnt].CHART_DIOX.splice(0, a[cnt].CHART_DIOX.length - 5);
	        					a[cnt].CHART_DO.splice(0, a[cnt].CHART_DO.length - 5);
	        					a[cnt].CHART_DTN.splice(0, a[cnt].CHART_DTN.length - 5);
	        					a[cnt].CHART_DTP.splice(0, a[cnt].CHART_DTP.length - 5);
	        					a[cnt].CHART_ECOLI.splice(0, a[cnt].CHART_ECOLI.length - 5);
	        					a[cnt].CHART_FE.splice(0, a[cnt].CHART_FE.length - 5);
	        					a[cnt].CHART_FL.splice(0, a[cnt].CHART_FL.length - 5);
	        					a[cnt].CHART_HCB.splice(0, a[cnt].CHART_HCB.length - 5);
	        					a[cnt].CHART_HCHO.splice(0, a[cnt].CHART_HCHO.length - 5);
	        					a[cnt].CHART_HG.splice(0, a[cnt].CHART_HG.length - 5);
	        					a[cnt].CHART_MN.splice(0, a[cnt].CHART_MN.length - 5);
	        					a[cnt].CHART_NH3N.splice(0, a[cnt].CHART_NH3N.length - 5);
	        					a[cnt].CHART_NHEX.splice(0, a[cnt].CHART_NHEX.length - 5);
	        					a[cnt].CHART_NO3N.splice(0, a[cnt].CHART_NO3N.length - 5);
	        					a[cnt].CHART_OP.splice(0, a[cnt].CHART_OP.length - 5);
	        					a[cnt].CHART_PB.splice(0, a[cnt].CHART_PB.length - 5);
	        					a[cnt].CHART_PCB.splice(0, a[cnt].CHART_PCB.length - 5);
	        					a[cnt].CHART_PCE.splice(0, a[cnt].CHART_PCE.length - 5);
	        					a[cnt].CHART_PH.splice(0, a[cnt].CHART_PH.length - 5);
	        					a[cnt].CHART_PHENOL.splice(0, a[cnt].CHART_PHENOL.length - 5);
	        					a[cnt].CHART_POP.splice(0, a[cnt].CHART_POP.length - 5);
	        					a[cnt].CHART_SS.splice(0, a[cnt].CHART_SS.length - 5);
	        					a[cnt].CHART_TCE.splice(0, a[cnt].CHART_TCE.length - 5);
	        					a[cnt].CHART_TCOLI.splice(0, a[cnt].CHART_TCOLI.length - 5);
	        					a[cnt].CHART_TEMP.splice(0, a[cnt].CHART_TEMP.length - 5);
	        					a[cnt].CHART_TN.splice(0, a[cnt].CHART_TN.length - 5);
	        					a[cnt].CHART_TOC.splice(0, a[cnt].CHART_TOC.length - 5);
	        					a[cnt].CHART_TP.splice(0, a[cnt].CHART_TP.length - 5);
	        					a[cnt].CHART_TRANS.splice(0, a[cnt].CHART_TRANS.length - 5);
	        					a[cnt].CHART_ZN.splice(0, a[cnt].CHART_ZN.length - 5);
