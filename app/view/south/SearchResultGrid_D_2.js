Ext.define('KRF_DEV.view.south.SearchResultGrid_D_2', {
	...
	items: [{
		xtype: 'container',
		id: 'searchResultContainer_D2_Id',
		width: '100%',
		height: '100%',
		items: [{
			xtype: 'grid',
						...
						tipTpl: new Ext.XTemplate(
						    ...
						    '</tpl>',
						    {
						        ...
						        formatY: function(yVal){
						        	yVal = Ext.util.Format.number(yVal, KRF_DEV.global.AttrFn.getAttrFormat(this.config.layerId,'RF'));
						            return yVal;
						        }
						    }
						),
