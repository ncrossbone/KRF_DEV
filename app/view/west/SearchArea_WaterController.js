Ext
		.define(
				'KRF_DEV.view.west.SearchArea_WaterController',
				{
					...
					onWaterSelect : function(button, eOpts) {
						...
						if (btnCtl != null) {
							...
							// 검색결과창 띄우기
							// ShowSearchResult(); // 선택버튼 클릭 시 검색결과창 안띄우는걸로..
							// 20151008
						}
						// }
					...
					onWaterReset : function(button, eOpts) {
						 ...
						 * Ext.HideSiteInfoWindow(); Ext.HideChartResult();
						 * //KRF_DEV.getApplication().fireEvent('drawEnd');
						 * 
						 * var combo1 = Ext.getCmp("cmbWater1"); var combo2 =
						 * Ext.getCmp("cmbWater2"); var combo3 =
						 * Ext.getCmp("cmbWater3"); combo1.setValue("");
						 * combo2.setValue(""); combo3.setValue("");
