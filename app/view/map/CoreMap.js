...
//        	me.baseMap.hide();
        	...
        	me.initVWorldSatelliteLayer();
    		me.initVWorldHybridLayer();
    		
    		me.satelliteMap = new VworldTiledSatelliteMapServiceLayer();
    		me.hybridMap = new VworldTiledHybridMapServiceLayer();
    		
    		me.map.addLayer(me.satelliteMap);
    		me.map.addLayer(me.hybridMap);
    		
    		me.satelliteMap.hide();
    		me.hybridMap.hide();
