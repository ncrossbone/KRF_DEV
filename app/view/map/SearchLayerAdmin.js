Ext.define('KRF_DEV.view.map.SearchLayerAdmin', {
	map:null, 
	toolbar:null,
	selectLayerInfo:{},
	geometry:null,
	...
	constructor: function(map, geometryService) {
		...
		me.layer1Url = KRF_DEV.app.layer1Url; // 레이어 URL
		...
		dojo.connect(me.targetGraphicLayer, "onClick", function(event){
			...
			//KRF_DEV.getApplication().fireEvent('spotChanged', properties);
		});
		...
		*/
		...
		KRF_DEV.getApplication().addListener('areaSelect', me.areaSelectHandler, me); 
    ...
    areaSelectHandler: function(info){
		...
		me.targetGraphicLayer.clear();
		me.highlightGraphicLayer.clear();
		var queryTask = new esri.tasks.QueryTask(KRF_DEV.app.layer1Url + info.layerId);
