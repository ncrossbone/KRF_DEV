Ext.define('KRF_DEV.view.map.ReachLayerAdminBackground', {
	...
	constructor: function(map) {
        ...
        this.dynamicLayer1 = new esri.layers.ArcGISDynamicMapServiceLayer(KRF_DEV.app.arcServiceUrl + "/rest/services/Gray/MapServer", {
        	"opacity": 0.6
        });
        
        me.layer = this.dynamicLayer1;
        this.dynamicLayer1.id = "ReachLayerAdminBackground"; // view.west.WestTabLayer의 각 탭 페이지 id와 일치시키자..
        this.dynamicLayer1.visible = false;
		me.map.addLayer(this.dynamicLayer1);
