Ext.define('KRF_DEV.view.drone.map.DroneFeatureLayerAdmin2', {
	map:null, 
	layer:null,
	dynamicLayer1:null,
	dynamicLayer2:null,
	...
	constructor: function(map,itemValue) {
		...
		queryTask.on("complete", function(featureSet) {
			...
			Ext.Ajax.request({
        		url: _API.drone_GetRWMDT, // './resources/jsp/drone/GetRWMDT.jsp',
	        ...
	        var featureCollection = {  
        		layerDefinition: me.layerDefinition,  
			...
			var selectionSymbol = new esri.symbol.SimpleMarkerSymbol(esri.symbol.SimpleMarkerSymbol.STYLE_SQUARE,
																    30,
																    new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new esri.Color([255, 255, 255, 0]), 2), // 투명도
			...
			require(["esri/symbols/SimpleFillSymbol",
					...
					function (SimpleFillSymbol, SimpleLineSymbol,Color){
						highlightSymbol = new SimpleFillSymbol (SimpleFillSymbol.STYLE_NULL,
			...
			me.layer.on("mouse-over", function(evt){
				var t =   "   <em class=\"viewtit1\">측정소명 : ${측정소명}</em>                                               " +
						  "   <table class=\"tst04\">																																			" +
				          "   	<colgroup>                                                                                " +
				          "       	<col width=\"100\">                                                                   " +
				          "       	<col width=\"83\">                                                                    " +
