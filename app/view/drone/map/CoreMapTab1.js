Ext.define('KRF_DEV.view.drone.map.CoreMapTab1', {
	...
	requires: [
		'KRF_DEV.view.drone.map.DynamicLayerAdmin1'
	],
	...
	mapRendered: function(p){
        ...
        var timerId = window.setInterval(function(){
        	...
        	me.dynamicLayerAdmin = Ext.create('KRF_DEV.view.drone.map.DynamicLayerAdmin1', me.map);
        	me.featureLayerAdmin = Ext.create('KRF_DEV.view.drone.map.FeatureLayerAdmin1', me.map);
        	...
        	KRF_DEV.getApplication().coreMap1 = me;
