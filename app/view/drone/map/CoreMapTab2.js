Ext.define('KRF_DEV.view.drone.map.CoreMapTab2', {
	...
	requires: [
		'KRF_DEV.view.drone.map.DynamicLayerAdmin2'
	],
	...
	mapRendered: function(p){
        ...
        var timerId = window.setInterval(function(){
        	...
        	me.dynamicLayerAdmin = Ext.create('KRF_DEV.view.drone.map.DynamicLayerAdmin2', me.map);
        	me.featureLayerAdmin = Ext.create('KRF_DEV.view.drone.map.FeatureLayerAdmin2', me.map);
        	//me.graphicsLayerAdmin = Ext.create('KRF_DEV.view.drone.map.GraphicsLayerAdmin1', me.map);
        	...
        	KRF_DEV.getApplication().coreMap2 = me;
		...
		dojo.declare('CustomMapsLayer', esri.layers.TiledMapServiceLayer, {
		    constructor: function(opts) {
		      ...
		      */
		      ...
		      Ext.SetInitialExtent("_mapDiv_2");
