Ext.define('KRF_DEV.view.drone.map.CoreMapTab3', {
	...
	requires: [
		'KRF_DEV.view.drone.map.DynamicLayerAdmin3'
	],
	...
	mapRendered: function(p){
        ...
        var timerId = window.setInterval(function(){
        	...
        	me.dynamicLayerAdmin = Ext.create('KRF_DEV.view.drone.map.DynamicLayerAdmin3', me.map);
        	me.featureLayerAdmin = Ext.create('KRF_DEV.view.drone.map.FeatureLayerAdmin3', me.map);
        	...
        	KRF_DEV.getApplication().coreMap3 = me;
		...
		dojo.declare('CustomMapsLayer', esri.layers.TiledMapServiceLayer, {
		    constructor: function(opts) {
		      ...
		      */
		      ...
		      Ext.SetInitialExtent("_mapDiv_3");
