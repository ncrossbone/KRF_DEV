Ext.define('KRF_DEV.view.drone.map.CoreMapTab4', {
	...
	requires: [
		'KRF_DEV.view.drone.map.DynamicLayerAdmin4'
	],
	...
	mapRendered: function(p){
        ...
        var timerId = window.setInterval(function(){
        	...
        	me.dynamicLayerAdmin = Ext.create('KRF_DEV.view.drone.map.DynamicLayerAdmin4', me.map);
        	me.featureLayerAdmin = Ext.create('KRF_DEV.view.drone.map.FeatureLayerAdmin4', me.map);
        	...
        	KRF_DEV.getApplication().coreMap4 = me;
		...
		dojo.declare('CustomMapsLayer', esri.layers.TiledMapServiceLayer, {
		    constructor: function(opts) {
		      ...
		      */
		      ...
		      Ext.SetInitialExtent("_mapDiv_4");
