...
Ext.define("KRF_DEV.global.TabFn", {
	...
	searchConditionInit: function(gridType, grid){
		...
		if(gridType == "수질자동측정망"){
			...
			cmbStartYear.setValue(KRF_DEV.global.CommFn.nowDate.getYear());
			cmbStartMonth.setValue(KRF_DEV.global.CommFn.nowDate.getMonth());
			
			cmbEndYear.setValue(KRF_DEV.global.CommFn.nowDate.getYear());
		...
		cmbStartDay.setValue(KRF_DEV.global.CommFn.nowDate.getDay());
		cmbStartHour.setValue("00");
		
		cmbEndDay.setValue(KRF_DEV.global.CommFn.nowDate.getDay());
